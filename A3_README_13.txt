...
===================How to excecute the scanner======================================================
Step1 : Modify config.json to change loginurl, username, password
Step2 : start.sh <configfilename>
example: start.sh config/config.json

Note: we have prepare the config.json file for all the eleven provided app in config/configForEachApp/ folder
for the hidden benchmark, please modify the config.json file.

The output folder contains the output from phase1, phase2 & phase3
The exploit script geenrate in phase4 are in exploit_scripts folder
...
The phase3 output can be generated by use below command:
